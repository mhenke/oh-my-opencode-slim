...
To use custom providers or a mixed-provider setup, use **[Configuration](docs/configuration.md)** for the full reference. If you want a ready-made starting point, check the **[Author's Preset](docs/authors-preset.md)**, **[$30 Preset](docs/thirty-dollars-preset.md)**, **[Zen Free Preset](docs/zen-free-preset.md)**, or **[NVIDIA Free Preset](docs/nvidia-free-preset.md)** - the `$30` preset is the best cheap setup.
...
| **[Zen Free Preset](docs/zen-free-preset.md)** | A free OpenCode Zen setup — $0/month |
| **[NVIDIA Free Preset](docs/nvidia-free-preset.md)** | A free NVIDIA NIM setup — $0/month |
